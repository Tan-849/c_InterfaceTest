from day08.commons.assert_util import AssertUtil
from day08.commons.extract_util import ExtractUtil
from day08.commons.model_util import verify_yaml
from day08.commons.requests_util import RequestUtil

eu = ExtractUtil()
re = RequestUtil()
au = AssertUtil()

def stand_case_flow(case_obj):
