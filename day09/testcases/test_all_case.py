...
from day09.commons.ddt_util import read_testcase
from day09.commons.main_util import stand_case_flow
from day09.commons.model_util import verify_yaml
from day09.commons.requests_util import logger
from day09.config import setting

@allure.epic(setting.project_name)
class TestAllCase():
    pass
    ...
    def func(self, caseinfo):
        ...
        if isinstance(caseinfo, list): # 多接口用例
            for case in caseinfo:
                logger.info(f"YAML 测试用例文件路径：{yaml_path}")
